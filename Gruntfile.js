...
module.exports = function(grunt) {
	...
	var compatBuild = ['clean:specs', 'packager:all', 'packager:specs', 'karma:sauceTask'];
	var nocompatBuild = ['clean:specs', 'packager:nocompat', 'packager:specs-nocompat', 'karma:sauceTask'];
