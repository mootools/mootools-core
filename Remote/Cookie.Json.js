...
Options:
	...
	duration - the duration of the Cookie before it expires, in seconds. You can also use $duration notation {days: 1, hours: 12}. If set to false or 0, the cookie will be a session cookie that expires when the browser is closed. This is default.
