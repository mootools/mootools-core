	...
	tests: [
		{
			...
			before: function(){
				if (!window.scroll_test_fx) window.scroll_test_fx = new Fx.Scroll('scrollExample', {duration: 500});
				window.scroll_test_fx.toBottom();
			}
		},
		{
		...
		},
		{
			...
			before: function(){
				if (!window.scroll_test_fx) window.scroll_test_fx = new Fx.Scroll('scrollExample', {duration: 500});
				window.scroll_test_fx.toElement('red');
			}
		}
	]
}
