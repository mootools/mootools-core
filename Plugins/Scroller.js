...
var Scroller = new Class({
	...
	*/
	...
	start: function(){
		...
		this.mousemover.addListener('mousemove', this.coord).addListener('trash', this.trash);
	},
	...
	*/
	...
	stop: function(){
		this.mousemover.removeListener('mousemove', this.coord).removeListener('trash', this.coord);
